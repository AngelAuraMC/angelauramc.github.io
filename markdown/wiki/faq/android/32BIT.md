...
## Compatibility
As of snapshot [24w14a](https://minecraft.wiki/w/Java_Edition_24w14a), Minecraft has officially dropped support for the 32-Bit architecture, ~~ultimately meaning if you own a 32-Bit device you will **NOT** be able to run Minecraft 1.20.5+ on said device.~~ Thanks to workarounds, you can play minecraft versions after 24w14a on 32-Bit devices.
