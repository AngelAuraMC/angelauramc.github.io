...
## Android
 ...
 There is a "Custom controls" button in the main menu. By clicking that you will be able to change your custom controls.

<img src="./images/Actions/android/IMG_3219.png" width=45% height=45%>

 You can access the options by clicking the cogwheel at the top of the screen.

<img src="./images/Actions/android/IMG_3220.png" width=75% height=75%>

 After clicking the cogwheel, you get a drawer with the following options:

<img src="./images/Actions/android/IMG_3221.png" width=75% height=75%>
...
<img src="./images/Actions/ios/IMG_3219.png" width=45% height=45%>

Press the custom controls button.

<img src="./images/Actions/ios/IMG_3220.png" width=45% height=45%>

After that, long press anywhere for more options.

<img src="./images/Actions/ios/IMG_3221.png" width=75% height=75%>

Now you will get a pop-up with the following options:

<img src="./images/Actions/ios/IMG_3222.png" width=75% height=75%>
