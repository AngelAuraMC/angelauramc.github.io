...
(") Demo Account is created if the Microsoft Account doesn't have Minecraft: Java Edition purchased. It can only run latest Minecraft in [Demo Mode](https://minecraft.wiki/w/Demo_Mode).
